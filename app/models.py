...
class UserSecret(Base):
    ...
    validation_scope: Mapped[str] = mapped_column(String(160), default="", server_default="")
    validation_code: Mapped[str | None] = mapped_column(String(64), nullable=True)
    validation_reference: Mapped[str | None] = mapped_column(String(64), nullable=True)
...
class PipelineDefinition(Base):
    ...
    source_schema: Mapped[str] = mapped_column(Text, default="")
    source_table: Mapped[str] = mapped_column(Text, default="")
    ...
    destination_schema: Mapped[str] = mapped_column(Text, default="")
    destination_table: Mapped[str] = mapped_column(Text, default="")
...
class PipelineRun(Base):
    ...
    reconciliation_reviewed_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
