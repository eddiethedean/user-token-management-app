    ...
    .tokens(
        {
            ...
            "surface.glass.border": "rgb(76 88 122 / 16%)",
            "surface.glass.shadow": "0 18px 48px rgb(30 41 74 / 10%), inset 0 1px rgb(255 255 255 / 92%)",
            # The component-scoped bundle uses the shorter aliases while the
            # complete Hedron stylesheet uses the surface.* names above.
            "glass.opacity": "78%",
            "glass.blur": "18px",
            "glass.border": "rgb(76 88 122 / 16%)",
            "glass.shadow": "0 18px 48px rgb(30 41 74 / 10%), inset 0 1px rgb(255 255 255 / 92%)",
...
_DATA_MOVER_THEME_TOKENS = {
    **_RESOLVED_THEME.tokens,
    ...
    "color.surface-muted": "#edf0f8",
    "color.fg": "#17213d",
    "color.muted": "#5b6680",
    "color.border": "#d4d9e8",
    "color.border-strong": "#b8c0d6",
    "color.accent": "#4053d6",
    "color.accent-hover": "#3245c3",
    "color.accent-soft": "#e7eaff",
    "color.focus": "#3347d1",
    "color.link": "#3448c5",
    "color.link-hover": "#273bab",
    "color.link-active": "#223494",
...
_DATA_MOVER_DARK_MODE = {
    **_RESOLVED_THEME.modes.get("dark", {}),
    ...
    "color.border-strong": "rgb(145 166 204 / 34%)",
    "color.accent": "#8d9cff",
    "color.accent-hover": "#aab6ff",
    "color.focus": "#8d9cff",
    "color.link": "#aab6ff",
    "color.link-hover": "#c6ccff",
    "color.link-active": "#eef0ff",
    "color.link-visited": "#c6b4ff",
