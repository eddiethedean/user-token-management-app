...
APP_REGIONS: tuple[FragmentRegion, ...] = (
    ...
    region_defs.SECRET_SLOT_MCSCOP,
    ...
    region_defs.PIPELINE_SOURCE_DATASET_SUGGESTIONS,
    region_defs.PIPELINE_SOURCE_FILE_SUGGESTIONS,
    region_defs.PIPELINE_TARGET_SELECT,
