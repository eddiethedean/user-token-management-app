...
``hedron.build`` package was removed from the wheel. Access Registry does not use
build manifests (``default_styles=False`` + ``/assets/theme.css``), so a minimal
stub is enough until upstream restores or drops the import.
"""
